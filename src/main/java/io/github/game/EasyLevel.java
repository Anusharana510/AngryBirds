...
public class EasyLevel implements Screen {
    ...
    private Texture blockA;
    private Texture blockB;
    private Texture pig;
    ...
    public void show() {
        ...
        font.getData().setScale(2f);// Adjust the scale factor to make the pig bigger
        ...
        blockA = new Texture("woods.png");
        blockB = new Texture("woods2.png");
        ...
        float w_ = 1.0f;
        float h_ = 3.0f;
        setting_blocks(9,2,w_,h_,blockA);
        setting_blocks(11,2,w_,h_,blockA);
        setting_blocks(10,7,3.0f,1.0f,blockB);
//        setting_blocks(8,1,1,1);
    ...
    void loss (){
        if (!bird_in_motion && remaining_pigs>0 && attempt==0){
            game.setScreen(new EasyLevelLoss(game));
        }
    }
...
//                System.out.println("Collision detected between: " + fixtureA + " and " + fixtureB);
                ...
                if ((first_body == "Piggy" && Second_body == "Ground") || (first_body == "Ground" && Second_body == "Piggy")) {
                    if (p_body != null) {
                        destroy_these_bodies.add(p_body);
                        p_body = null;
                        score+=10;
                        ...
                        if (remaining_pigs == 0){
                            game.setScreen(new EasyLevelWin(game));
                        }
                    }
                }
