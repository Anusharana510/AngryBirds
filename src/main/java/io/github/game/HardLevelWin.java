...
public class HardLevelWin implements Screen {
    ...
    public HardLevelWin(AngryBirds game){
        this.game = game;
    }
    ...
    public void show() {
        ...
        skin1 = new Skin(Gdx.files.internal("craftacular/skin/plain-james-ui.json"));

        font = new BitmapFont(Gdx.files.internal("w.fnt"));
        font.getData().setScale(2f);
        font.setColor(Color.RED);

        Next_Level = new TextButton("Home",skin1);
    ...
    public void render(float v) {
        ...
        font.draw(batch, message, 90, 450);
